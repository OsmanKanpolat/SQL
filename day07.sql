...
SELECT *
FROM words
WHERE word ~* '^y(.*)f$'; --'^y.*f$' de yazilabilir
...
SELECT word, SUBSTRING(word, 1, 2) AS s
FROM words
...
SELECT *
FROM developers
OFFSET 2 ROW --ROW zorunlu degil
LIMIT 3;
...
INSERT INTO employees5(id, sehir) VALUES(123, 'Ankara'); --not-null constraint, HATA
